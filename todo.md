...
## UI Polish - Facebook 스타일 채팅 팝업
- [x] Facebook 스타일 드래그 가능한 채팅 팝업 구현
- [x] 채팅 팝업에 키보드 표시 기능 추가
- [x] BottomNav에서 채팅 아이콘 제거
- [x] 메뉴 중복 문제 해결
- [x] 최종 배포


## Phase 5: Icon & Feature Improvements
- [x] 파란색 하트 아이콘 디자인 개선 (프로필 페이지)
- [x] 펫 생성 알고리즘 구현 (이름, 종류 선택 후 생성)
- [x] 펫 데이터 DB 저장 로직
...
## Phase 6: 기능 확장 (안전한 개발)
- [ ] 프로필 기능 강화 (사진 업로드, 자기소개)
- [ ] 앨범 기능 개선 (필터, 정렬)
- [ ] 채팅 기능 개선 (이모지, 음성 메시지)

**안전 체크포인트: version 80652141 (현재 정상 버전)**


## Phase 6: 아이폰 성능 최적화
- [x] 이미지 Lazy Loading 구옄 추가 (App, Home, Profile, Chat)
- [x] 번들 분석 완료 (불필요 라이브러리 없음)
- [x] 최종 배포

**안전 체크포인트: version 80652141 (단서 단계 시작 전 정상 버전)**


## Phase 7: APK 빌드 (웹 유지 + 별도 APK)
- [ ] Capacitor 설치 및 Android 프로젝트 생성
- [ ] 웹과 APK 백엔드 연결 설정
- [ ] APK 빌드 및 테스트
- [ ] 최종 배포 및 검증

**체크포인트: version 5890bc67 (APK 빌드 시작 전 정상 버전)**
